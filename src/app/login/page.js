...
export default function Login() {
  ...
  return (
    <div className="bg-white relative">
      <div className="flex flex-col items-center justify-center pt-8 xl:px-5 lg:flex-row">
        <div className="w-full max-w-lg px-10 py-8 bg-white shadow-lg rounded-xl">
